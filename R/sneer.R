...
#' function. The entry point for similarity preserving embeddings is the
#' function \code{\link{embed_sim}}. They have a similar signature, but
...
#' of the internals of the package.
#'
