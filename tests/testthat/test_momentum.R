...
nest_m <- mu(nesterov_nsc_momentum(burn_in = 0))
...
nest_max_m <- mu(nesterov_nsc_momentum(burn_in = 0, max_momentum = 0.9))
...
nest_m <- mu(nesterov_nsc_momentum(burn_in = 3))
expect_equal(nest_m(1), 0)
expect_equal(nest_m(2), 0)
expect_equal(nest_m(3), 0.4)
expect_equal(nest_m(4), 0.5)
expect_equal(nest_m(8), 0.7)
expect_equal(nest_m(13), 0.8)
expect_equal(nest_m(23), 0.88)
